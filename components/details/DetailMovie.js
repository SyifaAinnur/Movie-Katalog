            ...
            <View
              ...
              <View style={{marginLeft: 150, marginTop: 20}}>
                ...
                <View style={{width: '100%', justifyContent: 'space-between'}}>
                  <View
                    style={{width: 75, position: 'relative', marginBottom: 5}}>
                    <View
                      style={{
                        width: `${this.state.data.vote_average * 10}%`,
                        display: 'flex',
                        flexDirection: 'row',
                        overflow: 'hidden',
                        position: 'absolute',
